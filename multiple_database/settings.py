...
SECRET_KEY = '^jv8qyebk)#&qcn!w&jweifgcdn_oo&$9@+d$30l^3btvktk2d'
...
DATABASE_ROUTERS = ['routers.dbrouters.AuthRouter', 'routers.dbrouters.First', 'routers.dbrouters.Second']
